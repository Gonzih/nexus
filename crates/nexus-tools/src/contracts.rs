...
/// Nexus Contracts tool — post, browse, accept, settle work contracts on the
...
impl Tool for ContractsTool {
    ...
    fn definition(&self) -> ToolDefinition {
        ToolDefinition {
            name: "nexus_contracts".into(),
            description: r#"Interact with the Nexus work contract marketplace on id-service.
...
mod tests {
    ...
    fn tool_name() {
        ...
        assert_eq!(t.name(), "nexus_contracts");
    }
