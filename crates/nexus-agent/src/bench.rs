...
pub fn generate_report(runs: &[BenchMetrics]) -> String {
    ...
    md.push_str("\n---\n\n");
    md.push_str("*Generated by `nexus --benchmark`*\n");
...
pub fn run_synthetic_benchmark() -> String {
    ...
    // Simulate a 20-turn conversation analyzing nexus-infra
...
fn build_synthetic_conversation() -> Vec<Message> {
    ...
    msgs.push(Message::user("Analyze the nexus-infra monorepo. List all services, their ports, programming languages, and test counts. Identify the key architectural patterns."));

    // Turn 1: Assistant uses ls
    msgs.push(assistant_tc("Let me start by exploring the repository structure.", "ls", "tc1", r#"{"path": "/Users/feral/nexus-infra"}"#));
    msgs.push(Message::tool_result("tc1", "services/  soul/  nexus/  research/  .moon/  docker-compose.yml  Cargo.toml  package.json", false));

    // Turn 2: List services
    msgs.push(assistant_tc("I'll list the services directory.", "ls", "tc2", r#"{"path": "/Users/feral/nexus-infra/services"}"#));
    ...
    msgs.push(assistant_tc("Let me check the id-service first.", "read", "tc3", r#"{"path": "/Users/feral/nexus-infra/services/id-service/Cargo.toml"}"#));
    ...
    msgs.push(assistant_tc("Checking mock-llm-service.", "read", "tc5", r#"{"path": "/Users/feral/nexus-infra/services/mock-llm-service/Cargo.toml"}"#));
    ...
    let summary = "## Nexus Infrastructure Analysis\n\n\
        ### Services\n\n\
