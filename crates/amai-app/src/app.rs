...
impl AmaiApp {
    pub fn new() -> Self {
        ...
        Self {
            ...
            messages: vec![ChatMessage {
                ...
                content: "Welcome to AMAI. How can I help you?".into(),
                tool_name: None,
            }],
    ...
    /// Build the agent's tool registry — combines soul-coder tools with AMAI tools.
    fn build_tools(&self) -> ToolRegistry {
        ...
        // AMAI-specific tools will be added when UiBridge is wired
        registry
    }
    ...
    pub fn send_message(&mut self, text: String) {
        ...
        let system_prompt = self
            ...
            .clone()
            .unwrap_or_else(|| {
                "You are AMAI, a helpful AI agent running in the browser. \
        ...
        match &self.phase {
            ...
            AppPhase::Chat => {
                ...
                let header = Container::new("header")
                    ...
                    .with_gap(12.0)
                    .add_child(Box::new(
                        TextWidget::new("logo", "AMAI")
                            .with_font_size(16.0)
                            .with_bold(true)
                            .with_color(Color::from_hex("#7aa2f7")),
                    ))
                    .add_child(Box::new(
                        TextWidget::new("by", "by AMAI")
                            .with_font_size(12.0)
                ...
                if self.processing {
                    root = root.add_child(Box::new(
                        TextWidget::new("processing", "AMAI is thinking...")
